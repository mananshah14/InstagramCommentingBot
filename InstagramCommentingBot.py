...
posts=0 # variables to keep tracking of the posts
...
def Comment():  #Comments the first 9 posts
	...
	for y in range (1,4):
		for x in range(1,4):
			...
			post.click()
			sleep(2)
			postcomment = browser.find_element_by_class_name('_9AhH0')  #check out the class as per the browser and the instagram accounts
			sleep(2)
...
def start():
	...
	username.send_keys('python1408') # <-----------------------Enter INSTAGRAM USERNAME HERE -------------------------------------------------------------------------------------------------------------------------
	password = browser.find_element_by_name('password')
	password.send_keys('mananshah@17') # <-------------------- ENter INSTAGRAM PASSWORD HERE -----------------------------------------------------------------------------------------------------------------------
